...
// 修改动态导入的路径，使用绝对路径
const AIContentEditor = dynamic(() => import('@/app/components/AIContentEditor'), { 
  ssr: false,
  loading: () => <div>加载中...</div>  // 添加加载状态
});

const MarkdownCard = dynamic(() => import('@/app/components/MarkdownCard'), { 
  ssr: false,
  loading: () => <div>加载中...</div>
});

const HotPostEditor = dynamic(() => import('@/app/components/HotPostEditor'), { 
  ssr: false,
  loading: () => <div>加载中...</div>
});

const ImageTextEditor = dynamic(() => import('@/app/components/ImageTextEditor'), { 
  ssr: false,
  loading: () => <div>加载中...</div>
});
