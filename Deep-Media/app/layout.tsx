...
export const metadata: Metadata = {
  title: '渡己AI - 创新AI驱动写作助手 | 一键生成精美卡片',
  description: '使用渡己AI，快速生成吸引人的内容卡片。支持AI文案创作、精美排版、一键导出。',
  keywords: '渡己AI,小红书文案助手,小红书排版工具,小红书卡片制作,图文排版,AI文案,小红书笔记,爆款文案,小红书ai,ai笔记',
  authors: [{ name: '渡己AI助手' }],
  openGraph: {
    title: '渡己AI - 创新AI驱动写作助手 | 一键生成精美卡片',
    description: '使用渡己AI，快速生成吸引人的内容卡片。支持AI文案创作、精美排版、一键导出。',
  ...
  return (
    <html lang="zh-CN">
      ...
      <body suppressHydrationWarning>
        ...
        <div id="analytics-container" suppressHydrationWarning>
          <AnalyticsWrapper />
        </div>
      </body>
    </html>
